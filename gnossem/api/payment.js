...
exports.redirecturl = function(req, res) {
       ...
       var order_id = parseInt(req.params.id);
        ...
        var description = 'paid';

        return;

        var query = "UPDATE jos_vm_order_payment SET order_payment_log = '"+description+"', order_payment_trans_id = '"+txn_id+"', payment_method_id=4 where order_id = "+order_id+"";
                    ...
                    connection.query(query, function(err,rows){
                        var resdata = {
                           ...
                           // res.redirect('http://gnossem.fountaintechies.com:3000/#/Thanks');
                      }); // oerder payment
