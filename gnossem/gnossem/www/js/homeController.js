...
function HomeController($rootScope, $scope, $location,$interval,$http ,$stateParams,$ionicLoading) {
	...
	*/	
	$scope.testVOIP = function() {
		alert('testVOIP called');
		
		$http.post('http://186.215.128.189:6380/cgi-bin/call.py?dst1=1111&&dst2=123456789').success(function(data) {
				  console.log(data);
				}).error(function() {
						alert("Please check your internet connection or data source..");
				});
		...
		$http({
					  method: 'GET',
					  url: 'http://186.215.128.189:6380/cgi-bin/call.py?dst1=1111&&dst2=123456789',
